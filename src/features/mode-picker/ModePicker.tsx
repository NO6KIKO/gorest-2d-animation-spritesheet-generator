...
export function ModePicker({ onOpenGame, onOpenRigged2D, onOpenSheetOnly }: ModePickerProps) {
  return (
    <main className="mode-picker-page">
      <section className="mode-picker-shell" aria-label="Choose Gorest workspace mode">
        ...
        <div className="mode-choice-grid" aria-label="Choose spritesheet workspace mode">
          ...
          <button type="button" className="mode-choice-card" onClick={onOpenRigged2D}>
            <span>Rigged 2D<br />Animation</span>
            <small>Generated by Codex</small>
          </button>
        </div>
      </section>
    </main>
